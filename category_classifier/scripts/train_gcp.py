...
job_display_name = f"{task}-{ts}-allenoise-clean-baseline"
...
job_args = [
    ...
    "--train-file-path=gs://kraken-anchor/learning-from-noisy-data/allenoise_cv/clean/cv/0/train",
    "--val-file-path=gs://kraken-anchor/learning-from-noisy-data/allenoise_cv/clean/cv/0/val",
    "--test-file-path=gs://kraken-anchor/learning-from-noisy-data/allenoise_cv/clean/cv/0/test",
    "--seed=42",
    "--loss=cross-entropy",
...
worker_pool_specs = [
    {
        ...
        "replica_count": 1,
        "python_package_spec": {
            "executor_image_uri": "us-docker.pkg.dev/vertex-ai/training/pytorch-gpu.1-13.py310",
